...
image_dir = '/gpfsstore/rech/jsy/uzj81mi/Segmentation_Datasets/Arabidopsis_3D/Raw/'
model_dir = '/gpfsstore/rech/jsy/uzj81mi/Segmentation_Models/'
save_dir = image_dir + 'varun_skeletor/'

noise_model_name = None #'CARE/denoising_generic_3D/' 
unet_model_name = 'Unet3D/Unet_Arabidopsis/'
star_model_name = None #'StarDist3D/ArabidopsisSeg/'
roi_model_name = None
