...
for fname in filesRaw:
     ...
     SmartSeedPrediction3D(SaveDir, fname, UnetModel, StarModel,NoiseModel, min_size = min_size, max_size = max_size,  n_tiles = n_tiles, UseProbability = True, otsu = otsu, filtersize = 0, seedpool = seedpool)
