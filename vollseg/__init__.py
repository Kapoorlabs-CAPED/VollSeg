...
register_aliases(UNET, 'Arabidopsis_Semantic_Segmentation',  'Arabidopsis_Semantic_Segmentation')
register_aliases(MASKUNET, 'Xenopus_Cell_Tissue_Segmentation',  'Xenopus_Cell_Tissue_Segmentation')
register_aliases(MASKUNET, 'Arabidopsis_Mask_Segmentation',  'Arabidopsis_Mask_Segmentation')
