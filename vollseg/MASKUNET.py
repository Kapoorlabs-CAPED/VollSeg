...
class MASKUNET(UNET):
     ...
     """Standard UNET network for image segmentation based on UNET network to obtain region of interest.
     ...
     Example
     -------
     >>> model = MASKUNET(config, 'my_model')

     Attributes
     ----------
     config : :class:`csbdeep.models.Config`
        Configuration of MASKUNET network, as provided during instantiation.
