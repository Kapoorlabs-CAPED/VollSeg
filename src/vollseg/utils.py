...
def VollCellSeg(
    ...
    if (
        prob_thresh_nuclei is None
        and nms_thresh_nuclei is None
...
def CellPoseWater(cellpose_mask, sized_smart_seeds):
    ...
    mask = erode_label_regions(cellpose_mask_copy, erosion_iterations = 4)
    ...
    watershedImage = expand_labels(watershedImage, distance=8) 
